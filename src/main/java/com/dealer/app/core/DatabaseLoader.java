...
public class DatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments applicationArguments) throws Exception {
        ...
        chrisDealer.addVehicle(new Vehicle("BMW","535i","1221343343322",
                "/images/2018bmw535i/2018bmw535i.jpeg",
        ...
        chrisDealer.addVehicle(new Vehicle("Mercedes-Benz","G63","1221343343322",
                "/images/2017mercedes-benzg63/2017mercedes-benzg63.jpeg",
                ExteriorColor.ORANGE, InteriorColor.BLACK, WheelDrive.AWD ,CarCondition.NEW, FuelType.DIESEL, BodyType.SUV,
                TransmissionType.AUTOMATIC, 2018, 223332, 5000, 80000, 80000,
                20, 25
        ));
        chrisDealer.addVehicle(new Vehicle("BMW","328i","1221343343322",
                "/images/2017bmw328i/bmw.jpeg",
        ...
        chrisDealer.addVehicle(new Vehicle("Merdedes-Benz","C-class Coupe","1221343343322",
                "/images/2016mercedesCclass/mercedes.jpeg",
        ...
        chrisDealer.addVehicle(new Vehicle("Mercedes-Benz","G63","1221343343322",
                "/images/2017mercedes-benzg63/2017mercedes-benzg63.jpeg",
                ExteriorColor.ORANGE, InteriorColor.BLACK, WheelDrive.AWD ,CarCondition.USED, FuelType.DIESEL, BodyType.SUV,
